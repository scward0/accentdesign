...
<html class="no-js" lang="en">
  ...
  <body <?php body_class(); ?>>
      ...
      <header class="row no-max pad main">
        ...
        <a class="desk-logo" href="<?php bloginfo('url'); ?>"><img src="http://198.58.102.147/accentdesign/wp-content/uploads/2016/11/new_accent_logo.png" width="200" alt="<?php bloginfo('name'); ?>"/></a>
